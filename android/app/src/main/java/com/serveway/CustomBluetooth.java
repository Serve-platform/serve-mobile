...
public class CustomBluetooth extends ReactContextBaseJavaModule {

    //Constructor
    public CustomBluetooth(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    public void onAdvertiseStart(String uuid) {
        ...
        tempCallback = new CustomBluetooth.SimpleAdvertiseCallback();
