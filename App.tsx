...
const web3 = new Web3();
// @ts-ignore
web3.setProvider(new web3.providers.HttpProvider('https://polygon-mumbai.g.alchemy.com/v2/W-XkZND8K-Mm3uW09In9Atd66Dj2j2X6'));
...
export const getMATICBalance = async (address: string | undefined): Promise<string> => {
  if (!address) {
    return '';
  }
...
export const getSEATBalance = async (address: string | undefined): Promise<string> => {
  if (!address) {
    return '';
  }
